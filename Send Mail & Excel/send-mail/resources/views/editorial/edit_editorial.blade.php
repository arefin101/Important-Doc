            ...
            <div class="grid">
                ...
                @csrf 
                    <div class="form-header">
                        <h4 style="padding-top:10px;">Edit Editorial</h4>
                        <hr>
                    </div>
                ...
                <div style="margin-left:50px;">
                     ...
                     <div class="fgrid-area" style="display:grid; grid-template-columns:repeat(2,1fr);">
                        <div class="fgrid-single" style="padding-top:15px;">
                            ...
                            <input value="1" name="is_breaking" type="checkbox" <?php if(in_array("1",$Editor0)){ echo "checked='checked'";}?>><br><br>
                        </div>
                        <div class="fgrid-single" style="padding-top:15px;">
                            <label for="">Is it Image news </label>
                            <input value="1" name="is_slider"type="checkbox" <?php if(in_array("1",$Editor1)){ echo "checked='checked'";}?>><br><br>
                        </div>
                        <div class="fgrid-single" style="padding-top:2px;">
                            <label for="">Is it Flash news </label>
                            <input value="1" name="is_image"type="checkbox" <?php if(in_array("1",$Editor2)){ echo "checked='checked'";}?>><br><br>
                        </div>
                        <div class="fgrid-single" style="padding-top:2px;">
                            <label for="">Is it Main news </label>
                            <input value="1" name="is_main"type="checkbox" <?php if(in_array("1",$Editor3)){ echo "checked='checked'";}?>><br><br>
                        </div>
                    ...
                    <div class="fgrid-area" style="display:grid; grid-template-columns:repeat(2,1fr);">
                        ...
                        <div class="fgrid-single">
                            ...
                            <input name="user_name" type="text" class="input_type_focus" id="user_name" value="{{ $Editor->user_name }}" style="width:60%; border:1px solid #ccc; padding:5px 3px; border-radius:5px"><br><br>
                        ...
                        <div class="fgrid-single">
                            ...
                            <input name="editorial_title" id="editorial_title" value="{{ $Editor->editorial_title }}" class="input_type_focus" style="width:60%; border:1px solid #ccc; padding:5px 3px; border-radius:5px"><br><br>
                     ...
                     <div class="fgrid-area" style="display:grid; grid-template-columns:repeat(2,1fr);">
                        ...
                        <textarea name="news" id="editor" class="input_type_focus" rows="10" cols="80">{{ $Editor->editorial_news }}
                        </textarea>
                    </div>
