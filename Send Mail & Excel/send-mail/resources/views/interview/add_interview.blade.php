            ...
            <div class="grid">
                ...
                @csrf 
                    <div class="form-header">
                        <h4 style="padding-top:10px;">Add Interview</h4>
                        <hr>
                    </div>
                ...
                <div style="margin-left:50px;">
                    ...
                    <div class="fgrid-area" style="display:grid; grid-template-columns:repeat(2,1fr);">
                        ...
                        <div class="fgrid-single">
                            ...
                            <input name="interview_title" id="interview_title" type="text" class="input_type_focus" style="width:60%; border:1px solid #ccc; padding:5px 3px; border-radius:5px"><br><br>
